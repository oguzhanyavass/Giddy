...
const SignUp = () => {
  ...
  const [shownSuccesModal, setShownSuccesModal] = useState(false)
    ...
    <ScrollView className='flex-1 bg-white'>
      <View className='flex-1 bg-white'>
        ...
        <ReactNativeModal
          ...
          onModalHide={() => {
            if (verification.state == 'success') setShownSuccesModal(true)
          }}>
        ...
        <ReactNativeModal isVisible={shownSuccesModal}>
          <View className='bg-white px-7 py-9 rounded-2xl min-h-[300px]'>
